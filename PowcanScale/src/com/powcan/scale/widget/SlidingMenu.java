...
public class SlidingMenu extends RelativeLayout {
	...
	public void setView(View leftView, View rightView, View centerView, int leftViewWidth, int rightViewWidth) {
		...
		RelativeLayout.LayoutParams centerParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
	 ...
	 */
	public void setWhichSideCanShow(boolean isLeftCanShow, boolean isRightCanShow) {
	...
	private void smoothScrollTo(int distance) {
		mScroller.startScroll(mCenterView.getScrollX(), 0, distance, 0, sDuration);
		invalidate();
	}
	...
	private void resumeLeftViewClickState() {
		if (mLeftViewToogleClicked) {
			...
			setWhichSideCanShow(mCanLeftViewShowBeforeToogle, mCanRightViewShowBeforeToogle);
		}
	}
